...
/**
 * @file
 * Enables modules and site configuration for LeadGen site installation.
 */

/**
 * Implements hook_install_tasks()
 */
function leadgen_install_tasks(&$install_state) {
 ...
 */
function leadgen_install_tasks_alter(&$tasks, $install_state) {
 ...
 */
function leadgen_form_install_configure_form_alter(&$form, $form_state) {
 ...
 * Implements hook_form_FORM_ID_alter()
 */
function leadgen_form_apps_profile_apps_select_form_alter(&$form, $form_state) {
 ...
 */
function leadgen_default_content(&$modules) {
